...
function HeroIntro() {
  return (
    <div className="flex min-w-0 items-center lg:w-[45vw] lg:max-w-[864px]">
      <div className="w-full max-w-[696px] lg:w-[36.25vw]">
        <h1 className="font-[Zodiak] text-[clamp(44px,12vw,62px)] leading-[0.94] tracking-[-0.04em] text-[#2f2217] sm:text-[64px] lg:text-[clamp(52px,4.167vw,80px)]">
          <span className="block">You Are a</span>
          <em className="block font-normal">Various Creator</em>
        </h1>

        <p className="mt-8 max-w-[696px] text-base leading-[1.5] tracking-[-0.02em] text-[#2f2217]/80 sm:mt-10 lg:mt-[clamp(32px,2.5vw,48px)] lg:text-[clamp(16px,1.042vw,20px)]">
