  ...
  return (
    <article className={`flex min-w-0 flex-col gap-5 ${className}`}>
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl bg-white ring-1 ring-[#2f2217]/25 ring-inset">
        <div className="absolute inset-0" data-product-image>
          <img
      ...
      <div className="flex flex-col items-start gap-3.5">
        ...
        <p className="rounded-[4px] bg-[#2f2217] p-2.5 text-base font-medium leading-none tracking-[-0.02em] text-[#f7f3ef] xl:text-[clamp(16px,1.042vw,20px)]">
          {product.price}
        </p>
      </div>
    </article>
